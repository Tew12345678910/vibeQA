...
import { listAudits, parseAndValidateAuditRequest, startAudit } from "../../../lib/audits/service";
...
function dateStringToEpoch(raw: string | undefined, endOfDay: boolean): number | undefined {
  if (!raw) {
    return undefined;
  }
