    ...
    const mockIssues = [
      {
        ...
        description: `The main banner image on ${url} has no alt attribute, making it inaccessible to screen readers.`,
      },
      {
        id: `mock-${Date.now()}-2`,
        ...
        priority: "P1" as const,
        category: "accessibility",
        description: `The primary call-to-action button on ${projectName} does not meet the 4.5:1 contrast ratio requirement.`,
      },
      {
        id: `mock-${Date.now()}-3`,
        ...
        category: "usability",
        description: `The contact form does not highlight invalid fields with visible error messages when submission fails.`,
      },
      {
        id: `mock-${Date.now()}-4`,
